...
const siteName = "Marietta Violin With Carla";
const frontendKind = "nuxt";
const frontendPort = Number(process.env.A11Y_FRONTEND_PORT || 3350);
const apiPort = Number(process.env.A11Y_API_PORT || 3050);
