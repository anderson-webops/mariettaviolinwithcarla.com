...
This checklist complements the automated `npm run a11y` axe smoke suite. Run it before shipping homepage, lesson information, booking/contact, media, privacy, and responsive layout changes.

## Screen Reader Pass

- macOS VoiceOver: open `/`; use `VO + Right Arrow` through each page, then jump by headings, landmarks, buttons, form controls, and links.
...
- Verify visible focus on header navigation, lesson links, contact or booking actions, media controls, and footer links.
