...
const studioNotes = [
  {
    label: "Where",
    value:
      "Marietta (East Cobb), near Roswell Rd & Johnson Ferry. Cozy home studio with quiet, dedicated practice space.",
    icon: "i-carbon-location",
  },
  {
    label: "How we meet",
    value:
      "In-person or Zoom. Clean copies of music, recordings, and practice notes provided after each lesson.",
    icon: "i-carbon-calendar",
  },
  {
    label: "Who I teach",
    value:
      "Beginners (age 6+), middle/high school orchestra students, and motivated adult learners.",
  ...
  <section class="grid gap-12 text-left">
    ...
    >
      <div class="grid items-center gap-10 md:grid-cols-[1.1fr_0.9fr]">
        <div class="space-y-5">
          <p
            class="text-[11px] uppercase tracking-[0.32em] text-amber-700 font-semibold"
          >
            Marietta, Georgia
          </p>
          <h1
          ...
          >
            Violin lessons with Carla — warm, encouraging, and tailored to every
            student.
          </h1>
          <p class="text-lg text-slate-700 dark:text-slate-200">
            Whether you're picking up the violin for the first time or preparing
            for an audition, Carla's studio pairs clear fundamentals with
            musicality and performance confidence.
          </p>
    ...
    <section id="lessons" class="grid gap-6 md:grid-cols-3">
      ...
      >
        <p
          class="text-sm uppercase tracking-[0.22em] text-amber-700 font-semibold"
        >
          {{ option.name }}
        </p>
        <p class="text-base font-semibold text-slate-900 dark:text-white">
    ...
    >
      ...
      >
        ...
        <div class="space-y-1">
          <p
            class="text-sm uppercase tracking-[0.18em] text-amber-800 font-semibold"
          >
            {{ note.label }}
          </p>
    ...
    >
      <div class="space-y-3">
        <p
          class="text-[11px] uppercase tracking-[0.28em] text-amber-700 font-semibold"
        >
          Current students
        </p>
      ...
      <div
        class="rounded-2xl bg-gradient-to-br from-amber-700 to-amber-500 p-6 text-white shadow-xl"
      >
        <p class="text-sm uppercase tracking-[0.24em] font-semibold">
          Need something?
        </p>
        <h3 class="mt-2 text-xl font-semibold">Parent & student quick help</h3>
        <p class="mt-2 text-sm text-amber-50/90">
          Email Carla if you need a fresh practice plan, recordings, or to
          reschedule.
        </p>
    ...
    >
      <div class="space-y-3">
        ...
        <p class="text-sm text-slate-700 dark:text-slate-200">
          Tell me a bit about the student, experience level, and times that work
          best. We'll set a relaxed trial lesson and send you a simple practice
          outline afterward.
        </p>
      </div>
      <div class="flex flex-wrap gap-3">
