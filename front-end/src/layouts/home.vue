...
<template>
	...
	>
		...
		<header class="relative z-10 container mx-auto max-w-6xl flex items-center justify-between gap-6 px-6 py-6">
		...
		<div v-if="announcement.enabled" class="relative z-10 container mx-auto max-w-6xl px-6">
			<div
		...
		<main class="relative z-10 container mx-auto max-w-6xl px-6 pb-16 pt-2">
			<slot />
		</main>

		<div class="relative z-10 container mx-auto max-w-6xl px-6 pb-10">
			<Footer />
		</div>
	</div>
</template>
