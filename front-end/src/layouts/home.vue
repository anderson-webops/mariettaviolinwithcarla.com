<template>
  ...
  >
    ...
    >
      <div
        class="absolute -left-24 top-10 h-64 w-64 rounded-full bg-amber-200"
      />
      <div
        class="absolute right-0 top-32 h-72 w-72 rounded-full bg-emerald-200"
      />
      <div
        class="absolute bottom-0 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-amber-300/60"
      />
    </div>

    <header
      class="relative z-10 container mx-auto flex items-center justify-between gap-6 px-6 py-6"
    >
      <div class="flex items-center gap-3">
        ...
        <div class="leading-tight">
          <p
            class="text-[11px] uppercase tracking-[0.3em] text-amber-700 font-semibold"
          >
            Violin studio
          </p>
      ...
      <nav
        class="hidden items-center gap-6 text-sm font-medium text-slate-700 dark:text-slate-200 md:flex"
      >
